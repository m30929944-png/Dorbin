// ============================================
// assistant_logic.js - هسته‌ی اصلی دستیار هوشمند
// ============================================
...
class IntelligentAssistant {
    ...
    // پاسخ‌دهی خودکار — فقط بر اساس چیزی که کاربر یادش داده، بدون افشای داده‌ی آموزشی خام
    async autoReply(message) {
        ...
        return null; // یعنی چیزی یاد نگرفته که جواب بده
    }
    ...
    // الگوریتم دیده‌شدن بر اساس فعالیت واقعی کاربر (نه فالوور تقلبی)
    // هرچه بیشتر پست بزنه، لایک بگیره و دستیارش رو آموزش بده، در اکسپلور بالاتر میاد
